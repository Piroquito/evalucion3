...
import com.edder.restaurante_ec3.databinding.ItemShowResumeBinding;
import com.edder.restaurante_ec3.model.Platos;
import com.edder.restaurante_ec3.model.Internacionales;
...
public class RVResumeAdapter extends RecyclerView.Adapter <RVResumeAdapter.ResumeVH>{
    ...
    class ResumeVH extends RecyclerView.ViewHolder{
        ...
        public void bind(Shows show) {
            if(show instanceof Platos){
                binding.txtSeason.setVisibility(View.GONE);
            }else if (show instanceof Internacionales){
                binding.txtSeason.setVisibility(View.VISIBLE);
                binding.txtSeason.setText("Nacional "+ ((Internacionales)show).getDesciption());
            }
